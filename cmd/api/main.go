...
// command-line flag.
// ===================================================================================
// Added maxOpenConns, maxIdleConns,maxIdleTime fields to hold the configuration settings
...
func main() {
	...
	// Read the connection pool settings from the command-line flags into the config struct.main
	// Note the default values I'm using.
...
func openDB(cfg config) (*sql.DB, error) {
	...
	// Passing values less than or equal to 0 will mean there's no limit.
	db.SetMaxOpenConns(cfg.db.maxOpenConns)

	// Set the maximum number of  idle connections in the pool.
	// less than or equal to 0 mean there's no limit.
	db.SetMaxIdleConns(cfg.db.maxIdleConns)

	// time.ParseDuration() will convert the idle timeout duration string
	// to a timeout.Duration type.
